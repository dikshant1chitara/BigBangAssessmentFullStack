...
namespace AngularAuthYtAPI.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        public async Task<IActionResult> Authenticate([FromBody] Patient userObj)
        {
            ...
            var user = await _authContext.Patients.FirstOrDefaultAsync(x => x.Username == userObj.Username);
        ...
        private Task<bool> CheckUsernameExistAsync(string? username)
            => _authContext.Patients.AnyAsync(x => x.Email == username);
        ...
        [HttpGet]
        public async Task<ActionResult<Patient>> GetAllUsers()
        {
