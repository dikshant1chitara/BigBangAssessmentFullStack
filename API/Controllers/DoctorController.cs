...
namespace AngularAuthYtAPI.Controllers
{
    ...
    public class DoctorController : ControllerBase
    {
        ...
        private Task<bool> CheckUsernameExistAsync(string? username)
            => _authContext.Doctors.AnyAsync(x => x.Email == username);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateUser(int id, [FromBody] Doctor updatedUserObj)
        {
            var user = await _authContext.Doctors.FindAsync(id);
            if (user == null)
                return NotFound(new { Message = "User not found!" });
            ...
            user.Password = PasswordHasher.HashPassword(updatedUserObj.Password);
        ...
        public async Task<IActionResult> DeleteUser(int id)
        {
            ...
            _authContext.Doctors.Remove(user);
            await _authContext.SaveChangesAsync();
